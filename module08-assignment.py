...
services = {
    ...
    "Cybersecurity": 160,
    "Software": 230,
    "Technology Training": 120,
    "Security Management": 210
}
...
customer2 = {
    ...
    "email": "bob.brown@futuretech.com",
    "phone": "408-4536",
}

customer3 = {
    "company_name": "Secure Capital",
    "contact_person": "Nick Young",
    "email": "nick.young@securecapital.com",
    "phone": "234-0987",
}

customer4 = {
    "company_name": "Velocity Cove",
    "contact_person": "William Vick",
    "email": "william.vick@velocitycove.com",
    "phone": "655-8877",
} 
...
print("-" * 60)
# Add your code here
customers["C001"]["phone"] = "144-9232"
customers["C002"]["industry"] = "Software"
...
print("-" * 60)
# Add your code here
project1 = {"name": "Security Sale", "service": "Cybersecurity", "hours": 65, "budget": 12000}
project2 = {"name": "Sales Data Insight", "service": "Web Development", "hours": 30, "budget": 16500}
project3 = {"name": "Analysis Review", "service": "Software", "hours": 40, "budget": 13000}
project4 = {"name": "Tech Support", "service": "Technology Training", "hours": 90, "budget": 25000}
project5 = {"name": "Contact Team", "service": "Security Management", "hours": 25, "budget": 14000}
...
for id, plist in projects.items():
    print(id, plist)
...
company_names = [comp["company_name"] for comp in customers.values()]
...
for id, info in customers.items():
    ...
    plist = projects.get(id, [])

    num_projects = len(plist)
    customer_hours = sum(project["hours"] for project in plist)
    customer_budget = sum(project["budget"] for project in plist)
...
print("-" * 60)
# Add your code here
active_customers = {id: customers[id] for id in projects if len(projects[id]) > 0}
...
print("-" * 60)
# Add your code here
customer_budgets = {id: sum(project["budget"] for project in plist) for id, plist in projects.items()}
...
for id, info in customers.items():
    print(id, validate_customer(info))
...
def analyze_customer_budgets(projects_dict):
    ...
    for id, plist in projects_dict.items():
...
for id in customers:
    print(id, recommend_services(id, customers, projects, services))